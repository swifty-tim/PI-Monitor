...
class DayTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.ipadTimerType.text = "  "+self.todaySchedules[indexPath.row].getHeaterType()
        cell.ipadTimerStart.text = "     "+self.todaySchedules[indexPath.row].getTimerStart().timeToString()
        cell.ipadTimerEnd.text = self.todaySchedules[indexPath.row].getTimerEnd().timeToString()
        return cell
    }
