...
class PingTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        self.performSegueWithIdentifier("routeSegue", sender: indexPath.row)
    }
    
    
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("pingCell", forIndexPath: indexPath) as! SpeedTableViewCell
        cell.cellHeader.text = self.networkValues[indexPath.row].getHostname()
        cell.cellLeftTop.text! = self.networkValues[indexPath.row].getTestDate()
        cell.cellLeftBottom.text = "Avg: "+self.networkValues[indexPath.row].getPingAvg()
        cell.cellRightTop.text! = "Max: "+self.networkValues[indexPath.row].getPingMax()
        cell.cellRightBottom.text! = "Min: "+self.networkValues[indexPath.row].getPingMin()
        return cell
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "routeSegue" {
            ...
            let subVC: RouteTableViewController = segue.destinationViewController as! RouteTableViewController
            subVC.networkID = self.networkValues[row].getID()
        }
